 ...
 *          言外之意，就需要比较对象的大小，如何实现？使用两个接口中的任何一个：Comparable或Comparator
...
public class CompareTest {
     ...
     *   或者实现了java.lang.Comparable接口的排序规则不是和当前的操作，
...
//                return 0;
    ...
    public void test4(){
        ...
        Arrays.sort(arr, new Comparator() {
            //指明商品比较大小的方式：按照产品名称从低到高排序,同名称再按照价格从高到低排序
            @Override
