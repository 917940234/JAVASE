 ...
 *      后续的添加和扩容操作与jdk7无异
 *
 * 2.3 小结：jdk7中的ArrayList的创建类似于单例的饿汉式，而jdk8中的ArrayList的对象的创建类似于单例的懒汉式，
 *          延迟了数组的创建，节省内存
 *
 * 3.LinkedList源码分析：
 ...
 * 同：三个类都实现了List接口，存储数据的特点相同：存储有序的、和重复的数据
 * 异：
 * @author: Youcheng_Zong
 * @email: 917940234@qq.com
 * @date: 2021-10-05 11:43
 * @version: v1.0
 */
public class ListTest {
     ...
     * int lastIndexOf(Object obj):返回obj在集合中首次出现的位置，没有返回-1
    ...
    public void test2() {
        ...
        //4.int IndexOf/lastIndexOf(Object obj):返回obj在集合中首次/末次出现的位置，没有返回-1
